...
void setup()
{
  ...
  if (debug == 1) while(!SerialUSB); // Start the Serial connection Sodaq Autonomo
  ...
  {
    debugSerial.println("Network settings succesfully written in the bee module.");
  }
  else
  {
    debugSerial.println("Error writing network setting in the bee module!");
  }
...
void loop()
{
  ...
  if (debug == 1){
    ...
    debugSerial.print("Sleeping for ");
    debugSerial.print(sleepTime/1000);
    debugSerial.println(" seconds.");
    delay(sleepTime);
  }
}
